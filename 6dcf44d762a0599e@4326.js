...
import define3 from "./1371b3b2446a73b4@307.js";
...
async function _data(dataInput,FileAttachment){return(
dataInput({
...
function _6(Wrangler,data){return(
Wrangler(data)
)}
...
md`To load the wrangler with a predefined list of operations, pass in the inputs as follows:

\`\`\`js
viewof wrangled = Wrangler(data, [], {inputs: myInputs})
\`\`\`
`
)}
...
function _Wrangler(html,get_cols,id_generator,operations,Event,render_inputs_panel,get_code_expression,render_code_panel,render_results_panel,render_operations_panel,aq,make_styles){return(
(data = [], data2 = [], options = {}) => {
  let {inputs = []} = options;
  ...
  wrapper.value = { data: aq.from(data), code: "", inputs }; // initial value
...
function _render_operations_panel(html,OperationsMenu,make_docs_icon){return(
...
function _render_code_panel(html,copy_code_button,format_code){return(
(expression = "") => {
...
function _render_results_panel(html,evaluate,aq,op,display_error,Inputs){return(
(expression, data, data2, callback = () => null) => {
  ...
  if(err_message) {
    ...
    results.appendChild(html`<style>.results_wrapper table {min-width: ${Object.keys(data[0]).length * 75}px}</style>`)
  }
...
function _render_inputs_panel(html,render_inputs){return(
...
function _render_inputs(d3,make_hamburger_icon,html,operations,Event){return(
(input_arr, wrapper) => {
...
function _OperationsMenu(html,capitalize,icons){return(
(
  operations = ["semijoin"],
  update = (d) => d,
  hoverUpdate = (d) => d
...
function _SliceInput(html){return(
...
function _FilterInput(html,make_select,d3){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  // Get column types
  let col_data = cols;
...
function _SampleInput(html,make_checkboxes){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _DeriveInput(html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _FoldInput(make_checkboxes,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _JoinInput(make_select,capitalize,html){return(
({
  id = "",
  type = "",
  cols = [],
...
function _SpreadInput(make_select,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _UnrollInput(make_select,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const categories = cols
    .filter((d) => d.type === "categorical")
    .map((d) => d.label);
...
function _PivotInput(make_select,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const categories = cols
...
function _ImputeInput(make_select,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _RenameInput(make_select,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const labels = cols.map((d) => d.label);
...
function _RelocateInput(make_select,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const labels = cols.map((d) => d.label);
...
function _OrderbyInput(make_select,make_checkboxes,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const labels = cols.map((d) => d.label);
  const select = make_select("col", labels, value[0]);
...
function _RollupInput(make_select,make_checkboxes,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _GroupbyInput(html,make_checkboxes){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const groups = cols
    .filter((d) => d.type === "categorical" || d.type === "date")
    .map((d) => d.label);
...
function _UngroupInput(html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _ReifyInput(html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _SetInput(html,capitalize){return(
({
  id = "",
  type = "",
  cols = [],
...
function _CountInput(html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _UnorderInput(html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
...
function _SelectInput(make_checkboxes,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const labels = cols.map((d) => d.label);
...
function _DedupeInput(make_checkboxes,html){return(
({ id = "", cols = [], value = [], options = {} } = {}) => {
  const labels = cols.map((d) => d.label);
  const checkboxes = make_checkboxes("select", labels, value);
...
function _display_error(html){return(
(err) => {
  let message = "";
  switch (true) {
...
function _get_code_expression(operations){return(
(inputs) => {
...
function _make_select(html){return(
...
function _make_checkboxes(html){return(
...
function _get_cols(getType){return(
(data) =>
...
function _copy_code_button(html,Copier,make_copy_icon){return(
(code_str) => {
...
function _prefixVarsInFormula(P){return(
...
function _format_code(html,md){return(
(code_str) => {
...
function _make_styles(html){return(
() => html`<style>
...
function _make_hamburger_icon(){return(
() => {
...
function _make_docs_icon(svg){return(
...
function _make_copy_icon(svg){return(
() => svg`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function _icons(FileAttachment){return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["protests.csv", {url: new URL("./files/100ba6c9ab25d7a4687eb6bc46809219508a9faf2b7ade6c7034b0490cc7709fcfca7a50f4b76fda051310f6a4898815c53a702418c3d8644f767e3a6e44ac7e.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["icons@4.json", {url: new URL("./files/3c2fd71a8faeeebda50f3647621d658fd2943e8e9c4661ae86f05309b75b5569b1a6731a3058b51726f88675fa46e9b3b57be9ec5e411fd76bb415c3d7730823.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer()).define(["md"], _2);
  main.variable(observer("viewof data")).define("viewof data", ["dataInput","FileAttachment"], _data);
  ...
  main.variable(observer()).define(["Wrangler","data"], _6);
  main.variable(observer()).define(["md"], _7);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer()).define(["md"], _9);
  main.variable(observer()).define(["md"], _10);
  main.variable(observer()).define(["md"], _11);
  main.variable(observer("Wrangler")).define("Wrangler", ["html","get_cols","id_generator","operations","Event","render_inputs_panel","get_code_expression","render_code_panel","render_results_panel","render_operations_panel","aq","make_styles"], _Wrangler);
  main.variable(observer("render_operations_panel")).define("render_operations_panel", ["html","OperationsMenu","make_docs_icon"], _render_operations_panel);
  main.variable(observer("render_code_panel")).define("render_code_panel", ["html","copy_code_button","format_code"], _render_code_panel);
  main.variable(observer("render_results_panel")).define("render_results_panel", ["html","evaluate","aq","op","display_error","Inputs"], _render_results_panel);
  main.variable(observer("render_inputs_panel")).define("render_inputs_panel", ["html","render_inputs"], _render_inputs_panel);
  main.variable(observer("render_inputs")).define("render_inputs", ["d3","make_hamburger_icon","html","operations","Event"], _render_inputs);
  main.variable(observer("OperationsMenu")).define("OperationsMenu", ["html","capitalize","icons"], _OperationsMenu);
  main.variable(observer("operations")).define("operations", ["SelectInput","FilterInput","d3","OrderbyInput","DeriveInput","prefixVarsInFormula","RenameInput","GroupbyInput","RollupInput","CountInput","SampleInput","SliceInput","RelocateInput","ReifyInput","UngroupInput","UnorderInput","JoinInput","FoldInput","PivotInput","SpreadInput","UnrollInput","DedupeInput","ImputeInput","SetInput"], _operations);
  main.variable(observer()).define(["md"], _20);
  main.variable(observer("SliceInput")).define("SliceInput", ["html"], _SliceInput);
  main.variable(observer("FilterInput")).define("FilterInput", ["html","make_select","d3"], _FilterInput);
  main.variable(observer("SampleInput")).define("SampleInput", ["html","make_checkboxes"], _SampleInput);
  main.variable(observer("DeriveInput")).define("DeriveInput", ["html"], _DeriveInput);
  main.variable(observer("FoldInput")).define("FoldInput", ["make_checkboxes","html"], _FoldInput);
  main.variable(observer("JoinInput")).define("JoinInput", ["make_select","capitalize","html"], _JoinInput);
  main.variable(observer("SpreadInput")).define("SpreadInput", ["make_select","html"], _SpreadInput);
  main.variable(observer("UnrollInput")).define("UnrollInput", ["make_select","html"], _UnrollInput);
  main.variable(observer("PivotInput")).define("PivotInput", ["make_select","html"], _PivotInput);
  main.variable(observer("ImputeInput")).define("ImputeInput", ["make_select","html"], _ImputeInput);
  main.variable(observer("RenameInput")).define("RenameInput", ["make_select","html"], _RenameInput);
  main.variable(observer("RelocateInput")).define("RelocateInput", ["make_select","html"], _RelocateInput);
  main.variable(observer("OrderbyInput")).define("OrderbyInput", ["make_select","make_checkboxes","html"], _OrderbyInput);
  main.variable(observer("RollupInput")).define("RollupInput", ["make_select","make_checkboxes","html"], _RollupInput);
  main.variable(observer("GroupbyInput")).define("GroupbyInput", ["html","make_checkboxes"], _GroupbyInput);
  main.variable(observer("UngroupInput")).define("UngroupInput", ["html"], _UngroupInput);
  main.variable(observer("ReifyInput")).define("ReifyInput", ["html"], _ReifyInput);
  main.variable(observer("SetInput")).define("SetInput", ["html","capitalize"], _SetInput);
  main.variable(observer("CountInput")).define("CountInput", ["html"], _CountInput);
  main.variable(observer("UnorderInput")).define("UnorderInput", ["html"], _UnorderInput);
  main.variable(observer("SelectInput")).define("SelectInput", ["make_checkboxes","html"], _SelectInput);
  main.variable(observer("DedupeInput")).define("DedupeInput", ["make_checkboxes","html"], _DedupeInput);
  main.variable(observer()).define(["md"], _43);
  main.variable(observer("display_error")).define("display_error", ["html"], _display_error);
  main.variable(observer("get_code_expression")).define("get_code_expression", ["operations"], _get_code_expression);
  main.variable(observer("make_select")).define("make_select", ["html"], _make_select);
  main.variable(observer("make_checkboxes")).define("make_checkboxes", ["html"], _make_checkboxes);
  main.variable(observer("get_cols")).define("get_cols", ["getType"], _get_cols);
  main.variable(observer("copy_code_button")).define("copy_code_button", ["html","Copier","make_copy_icon"], _copy_code_button);
  main.variable(observer("getType")).define("getType", _getType);
  main.variable(observer("prefixVarsInFormula")).define("prefixVarsInFormula", ["P"], _prefixVarsInFormula);
  main.variable(observer("evaluate")).define("evaluate", _evaluate);
  main.variable(observer("id_generator")).define("id_generator", _id_generator);
  main.variable(observer("format_code")).define("format_code", ["html","md"], _format_code);
  main.variable(observer("capitalize")).define("capitalize", _capitalize);
  main.variable(observer()).define(["md"], _56);
  main.variable(observer("make_styles")).define("make_styles", ["html"], _make_styles);
  main.variable(observer()).define(["md"], _58);
  main.variable(observer("make_hamburger_icon")).define("make_hamburger_icon", _make_hamburger_icon);
  main.variable(observer("make_docs_icon")).define("make_docs_icon", ["svg"], _make_docs_icon);
  main.variable(observer("make_copy_icon")).define("make_copy_icon", ["svg"], _make_copy_icon);
  ...
  main.variable(observer("P")).define("P", ["require"], _P);
  return main;
}
